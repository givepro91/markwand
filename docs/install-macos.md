# macOS 설치 가이드 — v0.3.0-beta.6

Markwand 는 Apple 코드사이닝·공증 미적용 베타 빌드입니다. **ad-hoc 서명** 이 적용되어 있어 터미널 명령 없이 우클릭 → 열기 로 실행할 수 있습니다.

> 이 버전은 **베타** 입니다. 릴리스 노트: [release-notes/v0.3.0-beta.6.md](./release-notes/v0.3.0-beta.6.md)
...
- **Apple Silicon (M1/M2/M3/M4)**: `Markwand-0.3.0-beta.6-arm64.dmg`
- **Intel Mac**: `Markwand-0.3.0-beta.6.dmg`
...
```bash
shasum -a 256 ~/Downloads/Markwand-0.3.0-beta.6-arm64.dmg
# 또는
shasum -a 256 ~/Downloads/Markwand-0.3.0-beta.6.dmg
```

예상 해시 (2026-04-22 빌드):

```
74fb37ba6cd1ffd58e2bd6bdbea02a6cb02376f2103a9cf01fb3ae0632a7b784  Markwand-0.3.0-beta.6-arm64.dmg
bebfb2a2ecb4d7ed5963e687499f0eb08748ec40ea0c53359a784a862301ee5f  Markwand-0.3.0-beta.6.dmg
```
...
```bash
xattr -dr com.apple.quarantine ~/Downloads/Markwand-0.3.0-beta.6*.dmg
```
