...
> 릴리스 노트: [release-notes/v0.4.0-beta.13.md](./release-notes/v0.4.0-beta.13.md)
...
완전히 매끄러운 더블클릭 설치는 Apple Developer Program 가입 후 Developer ID 서명 + 공증이 필요합니다. 현재 beta.13은 비용 없이 가능한 경로를 정직하게 안내하는 무료 배포판입니다.
