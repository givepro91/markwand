# macOS 설치 가이드 — v0.3.0-beta.3

Markwand 는 Apple 코드사이닝·공증 미적용 베타 빌드입니다. **ad-hoc 서명** 이 적용되어 있어 터미널 명령 없이 우클릭 → 열기 로 실행할 수 있습니다.

> 이 버전은 **베타** 입니다. 릴리스 노트: [release-notes/v0.3.0-beta.3.md](./release-notes/v0.3.0-beta.3.md)
...
- **Apple Silicon (M1/M2/M3/M4)**: `Markwand-0.3.0-beta.3-arm64.dmg`
- **Intel Mac**: `Markwand-0.3.0-beta.3.dmg`
...
```bash
shasum -a 256 ~/Downloads/Markwand-0.3.0-beta.3-arm64.dmg
# 또는
shasum -a 256 ~/Downloads/Markwand-0.3.0-beta.3.dmg
```

예상 해시 (2026-04-22 빌드):

```
6cb39514120cf0bb1126695fbbb50ccdf98b93355d88d7ea745f451e48c9b2d1  Markwand-0.3.0-beta.3-arm64.dmg
f2d3534641db0c89e048cf70c5bc81383de3864b849d5f27de92bde74457aeb5  Markwand-0.3.0-beta.3.dmg
```
...
3. 시스템 설정 열기 — 아래 **3가지 중 아무거나**:
   - (권장) 방금 마운트된 DMG 창에 있는 **`설치 도움말.webloc`** 을 더블클릭 → 시스템 설정 자동 이동
...
```bash
xattr -dr com.apple.quarantine ~/Downloads/Markwand-0.3.0-beta.3*.dmg
```
