...
- **Blocker**: none
- **Last Activity**: Shareable AI Handoff MVP — Handoff Markdown을 Claude/Codex에 바로 붙여넣는 실행형 구조로 재작성. What I Need From You, Current Situation, Guardrails, Open These First를 상단에 배치하고 성공 CTA를 "붙여넣기"로 명확화. spwk-product dev dogfood 437 docs scan OK, full test 451 PASS · typecheck PASS · build PASS (2026-05-03).
...
## Recently Done
1. Shareable AI Handoff MVP — AI handoff를 실행 지시형 Markdown으로 재구성하고 Claude/Codex 붙여넣기 CTA까지 연결.
2. First Project Aha Path MVP — 위키 최상단에서 다음 행동 1개를 제시하고, 문제 확인/첫 문서/AI 전달 흐름을 한 카드로 연결.
3. Project Situation Pulse MVP — 최근 Git 흐름을 비개발자도 읽을 수 있는 현재 상황 카드로 해석하고, 관련 문서 열기/AI handoff 문맥까지 연결.
...
## Open Product Work
- Next: `docs/plans/productization-backlog.md` 기준 P1 Trust Calibration — 오래된 계획/기록과 현재 가이드를 더 명확히 구분해 과잉 경고를 줄인다.
