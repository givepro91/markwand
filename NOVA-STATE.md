...
## Current
- **Goal**: v0.4 UX Overhaul + Annotation MVP 릴리스 완료. v0.5 후속 후보(다색 팔레트 · note popover · SSH annotation · annotation 검색) 대기.
- **Phase**: **handoff** — v0.4.0-beta.3 (S7 Annotation MVP) 공개 완료. dogfood 피드백 수신 대기.
- **Blocker**: none
- **Remote**: git@github-givepro91:givepro91/markwand.git (main) — origin = `09ee687` (v0.4.0-beta.3 SHA256). tag `v0.4.0-beta.3` 원격 반영 완료. GitHub Release prerelease 공개: https://github.com/givepro91/markwand/releases/tag/v0.4.0-beta.3 (DMG arm64 `b73cbb3d…7d53` · x64 `ca85b1b8…0cb0`)
