...
## Current
- **Goal**: v0.4.0-beta.4 새로고침 UX 보강 릴리스 — bump 승인. 태그/DMG/GitHub Release 는 사용자 명시 승인 후.
- **Phase**: **release-prep** — beta.4 코드/노트/버전 준비 완료. typecheck PASS · 신규 단위 테스트 31건 PASS · 회귀 0.
- **Blocker**: none
- **Recently Done (3)**:
...
- **Last Activity**: v0.4.0-beta.4 — release notes 작성 + package.json bump (3→4) (2026-04-29).
- **Remote**: git@github-givepro91:givepro91/markwand.git (main) — origin = `6a8119d` (v0.4.0-beta.3 handoff). v0.4.0-beta.4 로컬 commit 대기.
