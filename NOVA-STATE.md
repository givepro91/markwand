...
- **Blocker**: none
- **Last Activity**: Plain-language UX pass — Project Wiki/Guide 용어를 한눈에 요약·문서 묶음·확인할 문제·결정 기록 중심으로 단순화하고, 좌측 `Claude로 열기`를 도구 비종속 `AI에게 전달하기` 복사 액션으로 교체. QA: typecheck PASS · vitest 398 PASS · build PASS (2026-05-01). lint는 로컬 eslint 바이너리 부재로 실행 불가.
...
## Recently Done
1. Plain-language UX pass — 비개발자도 이해하기 쉽게 Project Guide/Guide 문구를 쉬운 말로 정리하고, AI 전달 버튼을 클립보드 기반으로 교체.
